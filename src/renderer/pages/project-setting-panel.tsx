...
// import "./project-setting-panel.less";
// import { Row, Col } from "antd";
// import { AVGProjectData } from "../manager/project-manager";

// interface IProjectSettingPanelProps {
...
// export const ProjectSettingPanel: React.FC<IProjectSettingPanelProps> = ({
//   project
// }) => {
...
//   const BaseSettingPanel = () => {
//     return (
//       <>
//         <FormGroup
//           helperText="游戏项目的名字，如「白色相簿2」"
//           label="项目名称"
...
//   const AdvancedSettingPanel: React.FC<IProjectSettingPanelProps> = ({
//     project
//   }) => {
//     return (
//       <>
...
//   const GameSettingPanel: React.FC<IProjectSettingPanelProps> = (
//     project: AVGProjectData
//   ) => {
//     return (
//       <>
...
//         <Tab id={SettingPanelTabID.BasePanel} title="基本" panel={<></>} />
//         <Tab
