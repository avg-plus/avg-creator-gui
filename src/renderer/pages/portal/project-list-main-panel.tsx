...
//   const [seletedItem, setSeletedItem] = useState<ProjectFileData | null>(null);
...
//   const handleAlertDelete = async (project: ProjectFileData) => {
...
//   const handleExploreDir = (selectedProjectItem: ProjectFileData) => {
...
//   const handleOpenInVSCode = async (selectedProjectItem: ProjectFileData) => {
//     if (!selectedProjectItem) {
//       return;
//     }
...
//   const handleServeProject = async (selectedProjectItem: ProjectFileData) => {
//     if (selectedProjectItem) {
...
//   const handleOpenProject = (project: ProjectFileData) => {
//     // dispatch({
...
//             </Empty>
//           )}
//           {state.projects.map((p: ProjectFileData) => (
//             <div
//               key={p._id}
//               onDoubleClick={() => {
//                 handleOpenProject(p);
