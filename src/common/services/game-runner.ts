...
//   static async runAsDesktop(project: ProjectFileData) {
...
//   static async serve(project: ProjectFileData) {
//     await this.close();
...
//   static async serveAssets(project: ProjectFileData) {
...
//   static async serveEngine(project: ProjectFileData, assetPort: number) {
//     // 查找引擎 package
//     const engineBundleDir = BundlesManager.getLocalEngineDir(
//       project.engineHash,
